...
import type { GetCardDetailsWithTxResponse } from "./backend";
import type { GetCardDetailsWithTxRequest } from "./backend";
...
export interface IBackendServiceClient {
    ...
    /**
     * @generated from protobuf rpc: GetCardDetailsWithTx(backend.v1.GetCardDetailsWithTxRequest) returns (backend.v1.GetCardDetailsWithTxResponse);
     */
    getCardDetailsWithTx(input: GetCardDetailsWithTxRequest, options?: RpcOptions): UnaryCall<GetCardDetailsWithTxRequest, GetCardDetailsWithTxResponse>;
}
/**
 * @generated from protobuf service backend.v1.BackendService
 */
export class BackendServiceClient implements IBackendServiceClient, ServiceInfo {
    ...
    getCardDetailsWithTx(input: GetCardDetailsWithTxRequest, options?: RpcOptions): UnaryCall<GetCardDetailsWithTxRequest, GetCardDetailsWithTxResponse> {
        ...
        return stackIntercept<GetCardDetailsWithTxRequest, GetCardDetailsWithTxResponse>("unary", this._transport, method, opt, input);
    }
}
