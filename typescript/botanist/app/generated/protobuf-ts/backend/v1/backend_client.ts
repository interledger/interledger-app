...
import type { InitQuote3DSRequest } from "./backend";
...
import type { SetQuoteOTPRequest } from "./backend";
...
export interface IOpenPaymentServiceClient {
    ...
    /**
     * @generated from protobuf rpc: SetQuoteOTP(backend.v1.SetQuoteOTPRequest) returns (backend.v1.Quote);
     */
    setQuoteOTP(input: SetQuoteOTPRequest, options?: RpcOptions): UnaryCall<SetQuoteOTPRequest, Quote>;
    /**
...
export class OpenPaymentServiceClient implements IOpenPaymentServiceClient, ServiceInfo {
    ...
    setQuoteOTP(input: SetQuoteOTPRequest, options?: RpcOptions): UnaryCall<SetQuoteOTPRequest, Quote> {
        ...
        return stackIntercept<SetQuoteOTPRequest, Quote>("unary", this._transport, method, opt, input);
    }
    /**
     * @generated from protobuf rpc: CreateIncomingPayment(backend.v1.CreateIncomingPaymentRequest) returns (backend.v1.IncomingPayment);
     */
...
export interface IBackendServiceClient {
     ...
     * Tabapay 3DS
     *
     * @generated from protobuf rpc: InitQuote3DS(backend.v1.InitQuote3DSRequest) returns (backend.v1.Init3DSResponse);
     */
    initQuote3DS(input: InitQuote3DSRequest, options?: RpcOptions): UnaryCall<InitQuote3DSRequest, Init3DSResponse>;
    /**
...
export class BackendServiceClient implements IBackendServiceClient, ServiceInfo {
    ...
    initQuote3DS(input: InitQuote3DSRequest, options?: RpcOptions): UnaryCall<InitQuote3DSRequest, Init3DSResponse> {
        ...
        return stackIntercept<InitQuote3DSRequest, Init3DSResponse>("unary", this._transport, method, opt, input);
    }
    /**
     * @generated from protobuf rpc: Init3DS(backend.v1.Init3DSRequest) returns (backend.v1.Init3DSResponse);
     */
