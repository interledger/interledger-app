...
>(({ children, className, ...props }, ref) => {
  return (
    <NavLink
      ...
      className={({ isActive }) =>
        clsx(
          'my-1 flex rounded-xl p-3 first:mt-0 last:mb-0 focus-visible:outline-2 focus-visible:outline-focus',
...
>(({ className, ...props }, ref) => {
  return (
    <button
      ref={ref}
      className={clsx(
        'flex rounded-xl bg-nav p-3 hover:bg-nav focus-visible:outline-2 focus-visible:outline-focus active:bg-nav-hover',
        className
      )}
      {...props}
    />
