...
import { BackIcon, ReceivedIcon, FAB, FilterIcon } from '~/components'
  ...
  return (
    <div className='w-full'>
      ...
      <div className='mx-auto grid min-h-[calc(100vh-9rem)] w-full grid-cols-4 content-start gap-4 gap-y-2 overflow-y-auto p-4 pb-24 sm:max-w-lg sm:grid-cols-8 sm:px-0 lg:max-w-3xl lg:grid-cols-12 xl:max-w-4xl'>
        {/* Activity item */}
        <div className='col-span-full h-12 rounded-xl bg-container sm:col-span-6 sm:col-start-2 lg:col-start-4' />
        <div className='col-span-full h-12 rounded-xl bg-container sm:col-span-6 sm:col-start-2 lg:col-start-1' />
        <div className='col-span-full h-12 rounded-xl bg-container sm:col-span-6 sm:col-start-2 lg:col-start-1' />
        <div className='col-span-full h-12 rounded-xl bg-container sm:col-span-6 sm:col-start-2 lg:col-start-1' />
        <div className='col-span-full h-12 rounded-xl bg-container sm:col-span-6 sm:col-start-2 lg:col-start-1' />
        <div className='col-span-full h-12 rounded-xl bg-container sm:col-span-6 sm:col-start-2 lg:col-start-1' />
        ...
        <Link
          ...
          className='col-span-full flex h-12 items-center justify-between rounded-xl bg-container px-3 sm:col-span-6 sm:col-start-2 lg:col-start-4'
        >
