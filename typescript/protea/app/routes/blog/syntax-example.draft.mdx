...
export const metaData = {
  title: 'Building the Fynbos blog that has a very very long title',
  authors: [
    cairin,
    {
      name: 'John does',
      twitterHandle: 'notaperson',
      avatar: '/fynbos.png'
    }
  ],
  description: 'Somethings must be said.',
  date: '2021-09-09',
  slug: 'test',
  preview: true
}

This won't deploy to the blog.
