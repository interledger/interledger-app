...
export async function loader(args: Route.LoaderArgs) {
  ...
  else return ilpWithdrawalLoader(args)
}
...
async function ilpWithdrawalLoader({ request }: Route.LoaderArgs) {
