...
> Customers ✔️!
> A cool-looking website ✔️!
> Wait, how do we handle payments?
...
We hope to enable ecommerce use cases with the Fynbos wallet (like those Ömer has been experimenting with) by the end of Q1 next year. To get an early preview be sure to join our [waitlist](/waitlist) and be among the first to try it out.