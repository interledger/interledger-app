...
export const handle: ApplicationProps = {
    ...
    scaffold: {
        header: {
            back: route('/'),
            title: 'Connect a Linkedin identity'
        }
    }
}
...
export async function loader({ request }: LoaderArgs) {
    ...
    if (state && code) {
        let resp = await grpcClient.linkedinCallback(
            {
              ...
              your Linkedin account:
                        ...
                        <div className='mt-10 flex items-start'>
                            ...
                            <div className='ml-5'>
                                ...
                                <p className='text-sm text-medium'>
                                    Grant Fynbos permission to connect to your Linkedin account.
                                </p>
                            </div>
                        </div>
                        <div className='mt-10 flex items-start'>
                    ...
                    <Button form='connect-linkedin' type='submit'>
                        Continue
                    </Button>
                </>
            )}
