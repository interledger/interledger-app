    ...
    <main className='w-full overflow-hidden'>
      <section className='relative mx-auto grid w-full grid-cols-4 content-start gap-4 gap-y-2 overflow-x-visible px-8 sm:max-w-lg sm:grid-cols-8 sm:px-0 lg:max-w-3xl lg:grid-cols-12 xl:max-w-[59rem]'>
        ...
        <div className='col-span-full mt-10 mb-48 flex flex-col justify-end pt-4 sm:col-span-6 sm:col-start-2 lg:col-start-4'>
          ...
          <span className='mt-4 text-sm'>
            The banking services of the Fynbos are powered by Machnet. Machnet
            is a financial technology company and not a bank. Banking services
            are provided by Machnet's partner banks who are Member FDIC. Machnet
