...
In that vein, after finishing his BSc in Engineering, Barnard completed a Diploma in Software Development and then went on to work for a few startups in the Stellenbosch area. He ended up on the core team for [Mxit](https://en.wikipedia.org/wiki/Mxit) where he built everything from chat bots, APIs for external developers, and myriad other things. He went back to his startup roots, but this time in Cape Town, joining [Luno](https://luno.com) where he worked on automated customer onboarding (KYC), savings wallets, and instant buy and sell features, to name a few.
