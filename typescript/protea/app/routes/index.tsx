...
function MarketingPage() {
  return (
    <main className='w-full overflow-hidden'>
      <section className='relative mx-auto grid w-full grid-cols-4 content-start gap-4 gap-y-2 overflow-x-visible px-4 sm:max-w-lg sm:grid-cols-8 sm:px-0 lg:max-w-3xl lg:grid-cols-12 xl:max-w-4xl'>
        ...
        <div className='relative col-span-full h-48 lg:h-56'>
          ...
          {/* Mobile */}
          <div className='absolute right-16 bottom-20 block h-20 w-20 rounded-tl-full bg-lime-300 lg:hidden' />
          <div className='absolute -right-4 bottom-20 block h-20 w-20 rounded-tr-full bg-lime-500 lg:hidden' />
          <div className='absolute right-16 bottom-0 block h-20 w-20 rounded-full bg-rose-500 lg:hidden' />
          <div className='absolute -right-4 bottom-0 block h-20 w-20 rounded-bl-full bg-yellow-200 lg:hidden' />
        </div>
      </section>
      ...
      <section className='relative mx-auto  grid w-full grid-cols-4 content-start gap-4 gap-y-2 overflow-x-visible px-4 sm:max-w-lg sm:grid-cols-8 sm:px-0 lg:max-w-3xl lg:grid-cols-12 xl:max-w-4xl'>
        ...
        <div className='relative order-9 col-span-full h-20'>
          <div className='absolute top-0 right-16 h-20 w-20 rounded-bl-full bg-slate-50 lg:right-20' />
          <div className='absolute top-0 -right-4 h-20 w-20 rounded-tr-full bg-slate-50 lg:right-0' />
      ...
      <div className='w-full bg-slate-50'>
        <section className='mx-auto grid w-full grid-cols-4 content-start  gap-4 gap-y-2 overflow-x-visible px-4 sm:max-w-lg sm:grid-cols-8 sm:px-0 lg:max-w-3xl lg:grid-cols-12 xl:max-w-4xl'>
          ...
          <div className='relative col-span-full h-20'>
            <div className='absolute top-0 -left-4 h-20 w-20 rounded-tr-full bg-app lg:-left-40' />
            <div className='absolute top-0 left-16 h-20 w-20 rounded-br-full bg-app lg:-left-20' />
          </div>
        </section>
      </div>
      <section className='mx-auto grid w-full grid-cols-4 content-start gap-4 gap-y-2 overflow-x-visible px-4 sm:max-w-lg sm:grid-cols-8 sm:px-0 lg:max-w-3xl lg:grid-cols-12 xl:max-w-4xl'>
