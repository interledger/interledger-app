  ...
  return (
    <main className='w-full overflow-hidden'>
      <section className='relative mx-auto grid w-full grid-cols-4 content-start gap-4 gap-y-2 overflow-x-visible px-4 sm:max-w-lg sm:grid-cols-8 sm:px-0 lg:max-w-3xl lg:grid-cols-12 xl:max-w-[59rem]'>
        ...
        <div className='col-span-full mt-16 hidden justify-center lg:flex'>
          <img loading='lazy' src={'/test.svg'}/>
        </div>
      ...
      <div className='w-full bg-slate-50'>
        <section className='mx-auto grid w-full grid-cols-4 content-start gap-4 gap-y-2 overflow-x-visible px-4 py-16 sm:max-w-lg sm:grid-cols-8 sm:px-0 sm:py-20 lg:max-w-3xl lg:grid-cols-12 xl:max-w-[59rem]'>
          <div className='col-span-full flex flex-col'>
            <div className='flex'>
              <Shape
                ...
                width='w-10'
              />
              <Shape radius='rounded-full' color='bg-rose-500' width='w-10' />
            </div>
            <div className='flex'>
              <Shape
          ...
          <div className='col-span-full mt-8 lg:col-span-6'>
            <p>
              Digital wallets are easy to set up, secure and make payments a
              breeze. But today’s wallets are closed systems. They offer no way
              to transact with other wallets.
            </p>
          </div>
          <div className='col-span-full mt-8 lg:col-span-6 lg:col-start-7'>
            <p>
              Payment pointers do for digital payments what email addresses did
              for digital messaging, making it easy for wallets to transact with
              one another in an open ecosystem.
            </p>
          </div>
      ...
      <div className='w-full bg-slate-50'>
        <section className='mx-auto grid w-full grid-cols-4 content-start gap-4 gap-y-2 overflow-x-visible px-4 sm:max-w-lg sm:grid-cols-8 sm:px-0 lg:max-w-3xl lg:grid-cols-12 xl:max-w-[59rem]'>
          ...
          <div className='col-span-full mt-4 flex items-center justify-center text-center'>
            <span className='text-lg text-medium lg:text-xl'>
              You cannot make a payment from an Apple Pay wallet to a Google Pay
              merchant, for instance, or send money from a PayPal wallet to
              someone unless they have a PayPal wallet too.
            </span>
          </div>
