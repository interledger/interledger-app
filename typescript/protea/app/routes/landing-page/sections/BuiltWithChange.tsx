    ...
    <PageSection className='built-with-change'>
      <div className='built-with-change-header'>
        ...
        <p className='text-h4'>
          ...
          across borders and currencies, without unnecessary barriers or
          extractive fees. This wallet is our commitment to building that future
          in the open and over time.
        </p>
      </div>
