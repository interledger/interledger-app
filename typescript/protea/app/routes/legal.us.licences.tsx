...
export async function loader() {
  const policy = await fetch('https://gmtsend.com/en/state-license-list', {
    headers: {
      'content-type': 'text/html; charset=UTF-8'
    }
  })

  const content = (await policy.text()).split('<body>')[1].split('</body>')[0]
