  ...
  return (
    <div className='w-full'>
      <div className='mx-auto grid w-full grid-cols-4 content-start gap-4 gap-y-2 overflow-y-auto px-8 pt-4 pb-24 sm:max-w-lg sm:grid-cols-8 sm:px-0 lg:max-w-3xl lg:grid-cols-12 xl:max-w-4xl'>
        <div className='col-span-full flex flex-col pt-5 sm:col-span-6 sm:col-start-2 lg:col-start-4'>
          {shapes.map((shapeRow, outerIndex, outerArray) => (
            <div
              className='flex w-full justify-center'
              key={shapeRow.toString()}
            >
        ...
        <div className='col-span-full flex flex-col space-y-2 pt-11 pb-8 sm:col-span-6 sm:col-start-2 lg:col-start-4'>
