...
import type { ValidateOTPResponse } from "./backend";
import type { ValidateOTPRequest } from "./backend";
...
export interface IBackendServiceClient {
    ...
    /**
     * @generated from protobuf rpc: ValidateOTP(backend.v1.ValidateOTPRequest) returns (backend.v1.ValidateOTPResponse);
     */
    validateOTP(input: ValidateOTPRequest, options?: RpcOptions): UnaryCall<ValidateOTPRequest, ValidateOTPResponse>;
    /**
     ...
     *
     * @generated from protobuf rpc: GetStatements(backend.v1.Empty) returns (backend.v1.GetStatementsResponse);
     */
    getStatements(input: Empty, options?: RpcOptions): UnaryCall<Empty, GetStatementsResponse>;
    /**
...
export class BackendServiceClient implements IBackendServiceClient, ServiceInfo {
    ...
    validateOTP(input: ValidateOTPRequest, options?: RpcOptions): UnaryCall<ValidateOTPRequest, ValidateOTPResponse> {
        ...
        return stackIntercept<ValidateOTPRequest, ValidateOTPResponse>("unary", this._transport, method, opt, input);
    }
    /**
     * Allows signing agreements and getting agreements by id.
     *
    ...
    getStatements(input: Empty, options?: RpcOptions): UnaryCall<Empty, GetStatementsResponse> {
        ...
        return stackIntercept<Empty, GetStatementsResponse>("unary", this._transport, method, opt, input);
    }
    /**
     * @generated from protobuf rpc: GetStatementPDF(backend.v1.GetStatementPDFRequest) returns (backend.v1.GetStatementPDFResponse);
     */
