...
const svgShapes: { [K in Radius]: (x: number, y: number) => string } = {
  ...
  'rounded-full': (x: number, y: number) =>
    `<rect x="${x}" y="${y}" width="40" height="40" rx="20" fill="black"/>`,
  'rounded-t-full': (x: number, y: number) =>
    `<path d="M${x} ${y}m0 20a20 20 -180 0 1 40 0v20h-40v-20Z" fill="black" />`,
  'rounded-tl-full': (x: number, y: number) =>
    `<path fill="black" d="M${x} ${y}m40 0v40h-40a40 40 -90 0 1 40 -40Z" />`,
  'rounded-tr-full': (x: number, y: number) =>
    `<path fill="black" d="M${x} ${y}a40 40 -90 0 1 40 40h-40v-40Z" />`,
  'rounded-b-full': (x: number, y: number) =>
    `<path fill="black" d="M${x} ${y}h40v20a20 20 -180 0 1 -40 0v-20Z" />`,
  'rounded-bl-full': (x: number, y: number) =>
    `<path fill="black" d="M${x} ${y}h40v40a40 40 -90 0 1 -40 -40Z" />`,
  'rounded-br-full': (x: number, y: number) =>
    `<path fill="black" d="M${x} ${y}h40a40 40 90 0 1 -40 40v-40Z" />`,
  'rounded-l-full': (x: number, y: number) =>
    `<path fill="black" d="M${x} ${y}m40 0v40h-20a20 20 -180 0 1 0 -40h20Z" />`,
  'rounded-r-full': (x: number, y: number) =>
    `<path fill="black" d="M${x} ${y}h20a20 20 -180 0 1 0 40h-20v-40Z" />`
}
