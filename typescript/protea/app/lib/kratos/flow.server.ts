 ...
 */
export function getCsrfTokenFromFlow(
  flow: KratosFlowWithUi | undefined
): string {
 ...
 */
export function getNodeValueFromFlow(
  flow: KratosFlowWithUi | undefined,
