...
export default function Page() {
  const { isUser, fynbosEnv } = useLoaderData<typeof loader>()
  const matches = useMatches()
  const location = useLocation()

  if (location.pathname == '/temp-cloudflare-error') return <CloudFlareError />

  // TODO: deprecate this once the Scaffold is ready
  if (fynbosEnv == 'prod') {
    ...
    if (layout == Layouts.Focus) layoutComponent = <FocusLayout />
    else if (layout == Layouts.Wallet) layoutComponent = <WalletLayout />
