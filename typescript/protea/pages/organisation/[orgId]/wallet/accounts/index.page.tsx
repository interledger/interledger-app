...
const WalletAccountsPage: NextPage<
...
> = ({ orgsForDashboard, preview }) => {
  return (
    <Dashboard
      ...
      route={Routes.organisationWalletAccounts}
    >
      <div className='mb-10 pt-4'>
        <span className='font-display text-4xl font-medium'>Accounts</span>
      </div>
    </Dashboard>
  )
}
...
export const getServerSideProps: GetServerSideProps = async (
  context
): Promise<GetServerSidePropsResult<WalletAccountsPageProps>> => {
