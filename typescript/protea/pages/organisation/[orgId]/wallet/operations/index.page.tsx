...
const WalletOperationsPage: NextPage<
...
> = ({ orgsForDashboard, preview }) => {
  return (
    <Dashboard
      ...
      route={Routes.organisationWalletOperations}
    >
      <div className='pt-4 mb-10'>
        <span className='text-4xl font-display font-medium'>Operations</span>
      </div>
    </Dashboard>
  )
}
...
type WalletOperationsPageProps = {
  session: Session
  orgsForDashboard: OrgsForDashboard
  preview: boolean
}
...
export const getServerSideProps: GetServerSideProps = async (
  context
): Promise<GetServerSidePropsResult<WalletOperationsPageProps>> => {
