...
# Single Position account only
./ttt reset
./ttt init --mode legacy
./ttt fund-liquidity gatehub EUR 10000
./ttt onboard alice gatehub EUR 100
./ttt transfer alice gatehub EUR carlos xago ZAR 10
./ttt settle gatehub xago EUR
./ttt transfer carlos xago ZAR alice gatehub EUR 5
./ttt settle gatehub xago EUR
./ttt export-ods --sheet "Single Pos Account" output/mega.ods

# Double Position account
./ttt reset
...
./ttt transfer carlos xago ZAR alice gatehub EUR  5
./ttt settle gatehub xago EUR
./ttt export-ods --sheet "Double Pos Accounts" output/mega.ods

# Double Position account with FX Account
./ttt reset
./ttt init --mode self-exchange
./ttt fund-liquidity gatehub EUR 10000
./ttt fund-liquidity xago ZAR 20000
./ttt onboard alice gatehub EUR 100
./ttt transfer alice gatehub EUR carlos xago ZAR 10
./ttt settle gatehub xago EUR
./ttt transfer carlos xago ZAR alice gatehub EUR 5
./ttt settle gatehub xago EUR
./ttt export-ods --sheet "Double Pos Accounts and FX" output/mega.ods
...
./ttt export-ods --sheet "Double Pos and Dedicated FX" output/mega.ods
