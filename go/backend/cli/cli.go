...
func ParseStartArgs() (*StartArgs, error) {
	...
	xagoExchangeBaseURL := os.Getenv("XAGO_EXCHANGE_BASE_URL")
	if xagoExchangeBaseURL == "" {
		return nil, errors.New("XAGO_EXCHANGE_BASE_URL is required")
	}
	...
	xagoGatehubGhOmnibusUserID := os.Getenv("XAGO_GATEHUB_GH_OMNIBUS_USER_ID")
	if xagoGatehubGhOmnibusUserID == "" && env.IsProd() {
		return nil, errors.New("XAGO_GATEHUB_GH_OMNIBUS_USER_ID is required in production")
	}

	xagoGatehubGhOmnibusUserAddress := os.Getenv("XAGO_GATEHUB_GH_OMNIBUS_USER_ADDRESS")
	if xagoGatehubGhOmnibusUserAddress == "" && env.IsProd() {
		return nil, errors.New("XAGO_GATEHUB_GH_OMNIBUS_USER_ADDRESS is required in production")
	}
	...
	return &StartArgs{
		...
		XagoExchangeBaseURL:             xagoExchangeBaseURL,
		...
		XagoGatehubGhOmnibusUserID:      xagoGatehubGhOmnibusUserID,
		XagoGatehubGhOmnibusUserAddress: xagoGatehubGhOmnibusUserAddress,
	}, nil
}
