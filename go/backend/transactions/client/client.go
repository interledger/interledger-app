...
func (c *client) SetTransactionAmountAndFee(ctx context.Context, ID string, amount currency.Amount, fee currency.Amount) error {
	return ops.SetTransactionAmountAndFee(ctx, c.b, ID, amount, fee)
}
