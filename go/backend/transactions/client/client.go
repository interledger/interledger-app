...
func (c *client) SetTransactionFX(ctx context.Context, ID, appliedRate, surcharge string, target currency.Amount) error {
	return ops.SetTransactionFX(ctx, c.b, ID, appliedRate, surcharge, target)
}
...
func (c *client) SetTransactionFeeAndStateCompleted(ctx context.Context, ID string, fee currency.Amount, state transactions.State, walletID string) error {
	return ops.SetTransactionFeeAndStateCompleted(ctx, c.b, ID, fee, state, walletID)
}
