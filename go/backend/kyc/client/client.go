...
func (c client) GetPersonaAccountAttributes(ctx context.Context, walletID string) (*kyc.PersonaAccountAttributes, error) {
	return ops.GetPersonaAccountAttributes(ctx, c.b, c.pc, walletID)
}
