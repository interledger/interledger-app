...
func Card2ACHTransferWorkflow(ctx workflow.Context, args gmt.TransfersArgs) (*Card2ACHResponse, error) {
	var a *Activity
...
func ACH2CardTransferWorkflow(ctx workflow.Context, args gmt.TransfersArgs) (*ACH2CardResponse, error) {
	var a *Activity
