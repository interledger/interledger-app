...
import (
	...
	fakecash "gitlab.com/fynbos/backend/providers/fakecash"
)
...
func (m *MockClient) Create(ctx context.Context, args fakecash.CreateArgs) (*fakecash.Account, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", ctx, args)
	ret0, _ := ret[0].(*fakecash.Account)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockClient) Get(ctx context.Context, id string) (*fakecash.Account, error) {
	m.ctrl.T.Helper()
