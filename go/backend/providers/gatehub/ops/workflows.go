...
func FundGatehubEURLiquidityAccountWorkflow(ctx workflow.Context, amount string) error {
	...
	if err := workflow.ExecuteActivity(ctx, a.FundGatehubEURLiquidityAccount, currencyAmount).Get(ctx, nil); err != nil {
		return err
	}
