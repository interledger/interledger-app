...
func startWorker(args *cli.StartArgs) {
	...
	w, err := temporal.NewTemporalWorker(b, b.gatehubConfig, b.xagoConfig, args.XagoPGPRecipient, args.XagoTravelRuleEmail, args.PTI.JWK, args.PTI.BaseURL, args.PTI.ClientID, args.Chimoney.Token, args.Rafiki.NodeEnabled, jobs.Config{
...
func NewBackends(args *cli.StartArgs, isWorker bool) *backends {
	...
	b.xagoConfig = xago_external.Config{
		...
		ExchangeBaseURL: args.XagoExchangeBaseURL,
	...
	b.gatehubConfig = gatehub.Config{
		...
		XagoGatehubGhOmnibusUserID:      args.XagoGatehubGhOmnibusUserID,
        XagoGatehubGhOmnibusUserAddress: args.XagoGatehubGhOmnibusUserAddress,
	}
