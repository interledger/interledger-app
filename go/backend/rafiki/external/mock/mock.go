...
func (m *MockClient) CreateIncomingPayment(ctx context.Context, input external.CreateIncomingPaymentInput) (*external.CreateIncomingPaymentCreateIncomingPaymentIncomingPaymentResponsePaymentIncomingPayment, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateIncomingPayment", ctx, input)
	ret0, _ := ret[0].(*external.CreateIncomingPaymentCreateIncomingPaymentIncomingPaymentResponsePaymentIncomingPayment)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CreateIncomingPayment indicates an expected call of CreateIncomingPayment.
func (mr *MockClientMockRecorder) CreateIncomingPayment(ctx, input interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateIncomingPayment", reflect.TypeOf((*MockClient)(nil).CreateIncomingPayment), ctx, input)
}
