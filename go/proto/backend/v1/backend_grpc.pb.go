...
const (
	...
	BackendService_GetBalanceDepositDetails_FullMethodName       = "/backend.v1.BackendService/GetBalanceDepositDetails"
...
type BackendServiceClient interface {
	...
	GetBalanceDepositDetails(ctx context.Context, in *GetXagoDepositDetailsRequest, opts ...grpc.CallOption) (*GetXagoDepositDetailsResponse, error)
...
func (c *backendServiceClient) GetBalanceDepositDetails(ctx context.Context, in *GetXagoDepositDetailsRequest, opts ...grpc.CallOption) (*GetXagoDepositDetailsResponse, error) {
	out := new(GetXagoDepositDetailsResponse)
	err := c.cc.Invoke(ctx, BackendService_GetBalanceDepositDetails_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BackendServiceServer interface {
	...
	GetBalanceDepositDetails(context.Context, *GetXagoDepositDetailsRequest) (*GetXagoDepositDetailsResponse, error)
...
func (UnimplementedBackendServiceServer) GetBalanceDepositDetails(context.Context, *GetXagoDepositDetailsRequest) (*GetXagoDepositDetailsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetBalanceDepositDetails not implemented")
}
...
func _BackendService_GetBalanceDepositDetails_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetXagoDepositDetailsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BackendServiceServer).GetBalanceDepositDetails(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BackendService_GetBalanceDepositDetails_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BackendServiceServer).GetBalanceDepositDetails(ctx, req.(*GetXagoDepositDetailsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BackendService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetBalanceDepositDetails",
			Handler:    _BackendService_GetBalanceDepositDetails_Handler,
		},
		{
