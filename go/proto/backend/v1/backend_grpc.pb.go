...
type BackendServiceClient interface {
	...
	// SmileID
	GetSmileIDToken(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*GetSmileIDTokenResponse, error)
}
...
func (c *backendServiceClient) GetSmileIDToken(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*GetSmileIDTokenResponse, error) {
	out := new(GetSmileIDTokenResponse)
	err := c.cc.Invoke(ctx, "/backend.v1.BackendService/GetSmileIDToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BackendServiceServer interface {
	...
	// SmileID
	GetSmileIDToken(context.Context, *Empty) (*GetSmileIDTokenResponse, error)
}
...
func (UnimplementedBackendServiceServer) GetSmileIDToken(context.Context, *Empty) (*GetSmileIDTokenResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetSmileIDToken not implemented")
}
...
func _BackendService_GetSmileIDToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BackendServiceServer).GetSmileIDToken(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/backend.v1.BackendService/GetSmileIDToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BackendServiceServer).GetSmileIDToken(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BackendService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetSmileIDToken",
			Handler:    _BackendService_GetSmileIDToken_Handler,
		},
	},
