...
const (
	...
	BackendService_CreateDynamicForm_FullMethodName           = "/backend.v1.BackendService/CreateDynamicForm"
...
func (c *backendServiceClient) CreateDynamicForm(ctx context.Context, in *CreateDynamicFormRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, BackendService_CreateDynamicForm_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _BackendService_CreateDynamicForm_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateDynamicFormRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BackendServiceServer).CreateDynamicForm(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BackendService_CreateDynamicForm_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BackendServiceServer).CreateDynamicForm(ctx, req.(*CreateDynamicFormRequest))
	}
	return interceptor(ctx, in, info, handler)
}
