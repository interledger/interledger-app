...
type BackendClient interface {
	...
	CreateTwitterAuthURL(ctx context.Context, in *CreateTwitterAuthURLRequest, opts ...grpc.CallOption) (*CreateTwitterAuthURLResponse, error)
}
...
func (c *backendClient) CreateTwitterAuthURL(ctx context.Context, in *CreateTwitterAuthURLRequest, opts ...grpc.CallOption) (*CreateTwitterAuthURLResponse, error) {
	out := new(CreateTwitterAuthURLResponse)
	err := c.cc.Invoke(ctx, "/backend.admin.v1.Backend/CreateTwitterAuthURL", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BackendServer interface {
	...
	CreateTwitterAuthURL(context.Context, *CreateTwitterAuthURLRequest) (*CreateTwitterAuthURLResponse, error)
}
...
func (UnimplementedBackendServer) CreateTwitterAuthURL(context.Context, *CreateTwitterAuthURLRequest) (*CreateTwitterAuthURLResponse, error) {
...
func _Backend_CreateTwitterAuthURL_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateTwitterAuthURLRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BackendServer).CreateTwitterAuthURL(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/backend.admin.v1.Backend/CreateTwitterAuthURL",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BackendServer).CreateTwitterAuthURL(ctx, req.(*CreateTwitterAuthURLRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Backend_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Backend_CreateTwitterAuthURL_Handler,
		},
	},
