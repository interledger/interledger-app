...
func main() {
	pulumi.Run(func(ctx *pulumi.Context) error {
		vpcPeerStack, err := pulumi.NewStackReference(ctx, "fynbos/aws-shared-euwest1-vpc-peering-prod/main", nil)
		if err != nil {
			return err
		}
		...
		vpcStack, err := pulumi.NewStackReference(ctx, "fynbos/aws-prod-useast2-networking/main", nil)
		if err != nil {
			return err
		}
