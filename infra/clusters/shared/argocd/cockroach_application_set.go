...
type cockroachApplicationSetArgs struct {
	Namespace pulumi.StringInput
}

func newCockroachApplicationSet(ctx *pulumi.Context, args cockroachApplicationSetArgs, opts ...pulumi.ResourceOption) error {

	_, err := apiextensions.NewCustomResource(ctx, "cockroach-application-set", &apiextensions.CustomResourceArgs{
		ApiVersion: pulumi.String("argoproj.io/v1alpha1"),
		Kind:       pulumi.String("ApplicationSet"),
		Metadata: metav1.ObjectMetaArgs{
			Name:      pulumi.String("cockroach"),
		...
		OtherFields: kubernetes.UntypedArgs{
			"spec": pulumi.Map{
				...
				"template": pulumi.Map{
					"metadata": pulumi.Map{
						"name": pulumi.String("{{cluster}}-cockroach"),
					},
					"spec": pulumi.Map{
						...
						"source": pulumi.Map{
							...
							"path":           pulumi.String("cockroach/envs/{{cluster}}"),
						},
						"destination": pulumi.Map{
							"server":    pulumi.String("{{url}}"),
							"namespace": pulumi.String("cockroach"),
						},
