...
type proteaApplicationSetArgs struct {
	Namespace pulumi.StringInput
}

func newProteaApplicationSet(ctx *pulumi.Context, args proteaApplicationSetArgs, opts ...pulumi.ResourceOption) error {

	_, err := apiextensions.NewCustomResource(ctx, "protea-application-set", &apiextensions.CustomResourceArgs{
		...
		OtherFields: kubernetes.UntypedArgs{
			"spec": pulumi.Map{
				...
				"template": pulumi.Map{
					"metadata": pulumi.Map{
						"name": pulumi.String("{{cluster}}-protea"),
					},
					"spec": pulumi.Map{
						...
						"source": pulumi.Map{
							...
							"path":           pulumi.String("protea/envs/{{cluster}}"),
						},
						"destination": pulumi.Map{
							"server":    pulumi.String("{{url}}"),
							"namespace": pulumi.String("protea"),
						},
