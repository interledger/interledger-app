...
func createNodeCert(ctx *pulumi.Context, args *NodeCertArgs, opts ...pulumi.ResourceOption) (*apiextensions.CustomResource, error) {
	cr, err := apiextensions.NewCustomResource(ctx, "postgres-node", &apiextensions.CustomResourceArgs{
		ApiVersion: pulumi.String("cert-manager.io/v1"),
		Kind:       pulumi.String("Certificate"),
		Metadata: v1.ObjectMetaArgs{
			Name: pulumi.String("postgres-node"),
		},
		OtherFields: kubernetes.UntypedArgs{
			"spec": pulumi.Map{
				...
				"secretName": pulumi.String("postgresdb-node"),
...
func CreateClientCert(ctx *pulumi.Context, args *ClientCertArgs, opts ...pulumi.ResourceOption) (*apiextensions.CustomResource, error) {
	cr, err := apiextensions.NewCustomResource(ctx, fmt.Sprintf("postgres-%s-client", args.Name), &apiextensions.CustomResourceArgs{
		ApiVersion: pulumi.String("cert-manager.io/v1"),
		Kind:       pulumi.String("Certificate"),
		Metadata: v1.ObjectMetaArgs{
			Name: pulumi.Sprintf("postgres-%s-client", args.Name),
		},
		OtherFields: kubernetes.UntypedArgs{
			"spec": pulumi.Map{
				...
				"secretName": pulumi.Sprintf("postgresdb-%s", args.Name),
				"issuerRef": pulumi.Map{
					"name":  pulumi.String(args.Issuer),
					"kind":  pulumi.String("Issuer"),
					"group": pulumi.String("cert-manager.io"),
