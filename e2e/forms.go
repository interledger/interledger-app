...
// generateDeterministicPhone generates a deterministic phone number for the given country.
...
// iFillInPhoneWithRandomNumber generates a phone number for the current user's country and fills it
