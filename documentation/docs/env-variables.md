...
| Variable | Description | Secret | Notes |
|---|---|---|---|
| `VALKEY_URL` | Valkey connection URL for caching and session data | Yes | Local default: `valkey://valkey:6379/0` (provided by local compose); consumed by the Go backend via `valkey/client` |
