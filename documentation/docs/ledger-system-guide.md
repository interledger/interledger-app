...
- **How often updated:** Immediately (within milliseconds) — Pacioli uses a synchronous in-process client ([`go/pacioli/client/local.go`](https://github.com/interledger/interledger-app/blob/main/go/pacioli/client/local.go)) making direct SQL calls to PostgreSQL; there is no message queue or eventual consistency within Pacioli itself
...
| Claim | Source | Notes |
|-------|--------|-------|
| Pacioli updates are synchronous / "within milliseconds" | [`go/pacioli/client/local.go`](https://github.com/interledger/interledger-app/blob/main/go/pacioli/client/local.go), [`go/pacioli/api.go`](https://github.com/interledger/interledger-app/blob/main/go/pacioli/api.go) | In-process SQL calls to PostgreSQL, no queue |
