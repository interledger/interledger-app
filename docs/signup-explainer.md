...
- **Phone verification issues?** → See [Phone Number Verification (OTP)](#4-phone-number-verification-otp)
...
**Handler:** [`grpc/signup.go`](../go/backend/grpc/signup.go)  
**Operation:** [`signup/ops/service.go::SetUserData`](../go/backend/signup/ops/service.go)
...
**Handler:** [`grpc/signup.go`](../go/backend/grpc/signup.go)  
**Operation:** [`signup/ops/service.go::SetMobileNumber`](../go/backend/signup/ops/service.go)
...
**gRPC:** `CompleteSignup`  
**Handler:** [`grpc/signup.go`](../go/backend/grpc/signup.go)  
**Operation:** [`signup/ops/service.go::Complete`](../go/backend/signup/ops/service.go)
...
**Handler:** [`grpc/address.go`](../go/backend/grpc/address.go)  
**Operations:**
...
**Handler:** [`grpc/user.go`](../go/backend/grpc/user.go)  
**Operation:** [`wallets/ops/ops.go::Create`](../go/backend/wallets/ops/ops.go)
...
**Worker registration:** [`temporal/worker.go`](../go/backend/temporal/worker.go)
...
**Feature file:** [`e2e/features/000-signup.feature`](../e2e/features/000-signup.feature)
...
**Test implementation:** [`e2e/gatehub_signup_clean.go`](../e2e/gatehub_signup_clean.go)
...
**Signup operations:** [`signup/ops/service_test.go`](../go/backend/signup/ops/service_test.go)
