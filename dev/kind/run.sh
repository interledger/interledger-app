...
docker tag 823058932981.dkr.ecr.eu-west-1.amazonaws.com/tigerbeetle@sha256:b1fe98356a0db183b56b555eac17c5a43f4b61305f5ac711ea741d5085a2f977 localhost:5005/tigerbeetle:latest
docker push localhost:5005/tigerbeetle:latest
